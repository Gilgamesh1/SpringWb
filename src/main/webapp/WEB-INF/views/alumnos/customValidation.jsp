<%-- 
    Document   : customValidation
    Created on : 20/05/2018, 11:38:36 PM
    Author     : Raúl
--%>
...
<html>
    ...
    <body>
    <body>
        <h1>Custom Validacion</h1>
        <form action="${pageContext.request.contextPath}/validacion/validate" method="post">
            <table>
                <tr>
